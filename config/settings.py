...
DEFAULT_LLM_MODEL = config('DEFAULT_LLM_MODEL', default='openai/gpt-oss-20b:free')
LLM_REQUEST_TIMEOUT = config('LLM_REQUEST_TIMEOUT', default=60, cast=int)
LLM_MAX_TOKENS = config('LLM_MAX_TOKENS', default=2000, cast=int)
